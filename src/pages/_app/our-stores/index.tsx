...
function RouteComponent() {
  return (
    <section className="container py-6">
      <img
        src={OurStoresBanner}
        alt="Banner interior da loja, com os tenis dispostos"
      ...
      <section className="text-black w-full space-y-20">
        <div className="flex flex-col md:flex-row items-center gap-2.5">
          <div className="text-center py-6">
            ...
            <p>
              ...
              experiomente nossos estilos mais recentes de perto.
            </p>
          </div>
          <img
            src={OurStoresImg1}
        ...
        <div className="flex flex-col md:flex-row items-center gap-2.5">
          ...
          <div className="text-center py-6 px-2">
            ...
            <p>
              Conte com dicas de estilo, sugestões exclusivas e siporte
              personaliyado de quem realmente entende de moda.
            </p>
          </div>
        </div>
      </section>
